...
export const reverseGeocode = async (payload: {
  ...
  // console.log('reverseGeocode running');
  let result = null;
  try {
    if (payload) {
      ...
      result = resultData.find((obj) => {
        if(payload.latitude === obj.results[0].geometry.lat &&
          payload.longitude === obj.results[0].geometry.lng) {
            return obj;
          }
      ...
      //         "rise": {
      //           "apparent": 1667023920,
      //           "astronomical": 1667017020,
      //           "civil": 1667021820,
      //           "nautical": 1667019420
      //         },
      //         "set": {
      //           "apparent": 1667059020,
      //           "astronomical": 1667065860,
      //           "civil": 1667061120,
      //           "nautical": 1667063520
      //         }
      //       },
